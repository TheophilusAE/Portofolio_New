...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" className="py-24 md:py-32 bg-stone-950 text-white">
              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-4 mb-5">
                  <div className="flex items-start gap-4">
                    <span className="pt-1.5">{exp.icon}</span>
                    <div>
                      <h3 className="font-serif text-2xl sm:text-3xl text-white mb-1.5">
                        {exp.title}
                      </h3>
                ...
                <div className="pl-0 sm:pl-10">
                  ...
                  {/* Key Achievements */}
                  <div className="mb-6">
                    <h4 className="text-xs uppercase tracking-[0.3em] text-stone-500 mb-3">
                      Key Achievements
                    </h4>
